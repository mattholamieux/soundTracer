...
function openScreen() {
  let f = 100;
  let directions = ['soundTracer', 'x places trig', 'z removes trig', 'c starts tick', 'v removes tick', 's shifts all trigs up', 'd shifts all trigs down', 'arrows navigate','click anywhere to begin', 'space toggles instructions'];
  textSize(18);
  textLeading(scl);
  textFont('serif');
